...
for (var a = "function" == typeof __require && __require, c = 0; c < i.length; c++) n(i[c]);
return n;
}({
...
o.AssetUtils = void 0;
var i = t("./BxAutoAsset"), n = t("./global"), a = function() {
function t() {}
...
e.newUrl = t;
e.spriteFrame = null;
cc.resources.load(t, cc.SpriteFrame, function(n, a) {
if (n) o && i.loadSprite(o, e); else if (cc.isValid(e) && e.newUrl == t) {
e.addAutoReleaseAsset(a);
e.spriteFrame = a;
} else i.checkAndReleaseAsset(a);
});
};
t.showDialog = function(t, e, o) {
cc.resources.load("prefeb/" + t, cc.Prefab, function(i, a) {
if (!i) {
var c = cc.instantiate(a);
n.Global.assetUtils.bindAutoReleaseAsset(c, a);
var s = n.Global.getsceneNode();
if (c && s) {
if (e) {
cc.log(t, "confirmExit_dialog");
c.getComponent(t).initData && c.getComponent(t).initData(e);
}
s.addChild(c);
var l = c.getChildByName("content");
l.scale = 0;
...
var n, a = arguments.length, c = a < 3 ? e : null === i ? i = Object.getOwnPropertyDescriptor(e, o) : i;
if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) c = Reflect.decorate(t, e, o, i); else for (var s = t.length - 1; s >= 0; s--) (n = t[s]) && (c = (a < 3 ? n(c) : a > 3 ? n(e, o, c) : n(e, o)) || c);
...
var c = t("../tool/gameData"), s = t("../tool/global"), l = cc._decorator, r = l.ccclass, u = (l.property, 
function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
...
var c = t("../tool/gameData"), s = t("../tool/global"), l = cc._decorator, r = l.ccclass, u = l.property, d = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.callback = null;
...
a([ u(cc.Node) ], e.prototype, "starBox", void 0);
a([ u(cc.Node) ], e.prototype, "clickBox", void 0);
return a([ r ], e);
}(cc.Component);
o.default = d;
cc._RF.pop();
...
var c = t("../tool/gameData"), s = t("../tool/global"), l = t("../tool/utils"), r = cc._decorator, u = r.ccclass, d = (r.property, 
function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
...
this.node.destroy();
c.gameData.closeBanner();
c.gameData.userData.isHall = !0;
c.gameData.storageData();
...
var i, n = t("./StorageUtils"), a = null, c = null, s = function() {
function t() {
this.levelAll = 30;
this.userData = {
isClause: !1,
...
a = null;
a = t;
} else cc.sys.isNative && cc.sys.OS_IOS == cc.sys.os ? jsb.reflection.callStaticMethod("UnityMgr", "loadReward", null) : t();
};
...
var c = t("../tool/gameData"), s = t("../tool/global"), l = t("../tool/utils"), r = cc._decorator, u = r.ccclass, d = r.property, h = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.title = null;
...
s.Global.imgId >= 6 && c.gameData.showInterst();
if (5 == s.Global.imgId && !c.gameData.userData.finishLevel5) {
c.gameData.userData.finishLevel5 = !0;
s.Global.assetUtils.showDialog(l.dialog.comment_dialog);
c.gameData.storageData();
}
};
e.prototype.start = function() {
...
a([ d(cc.RichText) ], e.prototype, "title", void 0);
...
var c, s = t("./prefeb/newhand"), l = t("./tool/gameData"), r = t("./tool/global"), u = t("./tool/utils"), d = cc._decorator, h = d.ccclass, p = d.property;
(function(t) {
t[t.find = 0] = "find";
t[t.err = 1] = "err";
t[t.finish = 2] = "finish";
...
i.setPosition(t);
var n = u.UtilsTool.changePos(o.node, i), a = .5;
t.y < 0 && (a = 1);
...
var n, a = this.imgData[i], s = a.centerPos.x * this.originalScale;
n = t.y > 0 ? a.centerPos.y * this.originalScale + this.setImgY : a.centerPos.y * this.originalScale - this.setImgY;
var l = a.blockSize.wid * this.originalScale, r = a.blockSize.hei * this.originalScale;
if (!a.isFind && t.x <= s + l / 2 && t.x >= s - l / 2 && t.y <= n + r / 2 && t.y >= n - r / 2) {
if (a.isFind) {
e = c.finish;
cc.log("找到重复的了");
} else {
...
a([ p(cc.Node) ], e.prototype, "originalImg", void 0);
a([ p(cc.Node) ], e.prototype, "finishImg", void 0);
a([ p(cc.Node) ], e.prototype, "tishi_qipao", void 0);
a([ p(cc.Prefab) ], e.prototype, "gameFindPrefab", void 0);
a([ p(cc.Prefab) ], e.prototype, "gameErrPrefab", void 0);
a([ p(cc.Prefab) ], e.prototype, "gameTishiPrefab", void 0);
a([ p(cc.Prefab) ], e.prototype, "game_tuowei", void 0);
a([ p(cc.Node) ], e.prototype, "imgSignBox", void 0);
a([ p(cc.Node) ], e.prototype, "yeziBox", void 0);
a([ p(cc.Label) ], e.prototype, "level", void 0);
a([ p(cc.Node) ], e.prototype, "timeAll", void 0);
a([ p(cc.Node) ], e.prototype, "reduceTime", void 0);
a([ p(cc.Node) ], e.prototype, "mask", void 0);
return a([ h ], e);
}(cc.Component);
o.default = g;
cc._RF.pop();
...
o.Global = void 0;
var i = t("./AssetUtils"), n = t("./AudioUtils"), a = function() {
function t() {
this.sceneNode = null;
this.imgId = 0;
...
var c = t("./prefeb/imgItem"), s = t("./tool/gameData"), l = t("./tool/global"), r = t("./tool/utils"), u = cc._decorator, d = u.ccclass, h = u.property, p = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.bg = null;
...
e.getComponent(c.default).init(t, this);
}
};
...
a([ h(cc.Prefab) ], e.prototype, "imgItem", void 0);
a([ h(cc.Node) ], e.prototype, "scroll_contect", void 0);
a([ h(cc.ScrollView) ], e.prototype, "scrollView", void 0);
a([ h(cc.Node) ], e.prototype, "toastNode", void 0);
return a([ d ], e);
}(cc.Component);
o.default = p;
cc._RF.pop();
...
this.index = t;
this.hall = e;
if (this.index < c.gameData.userData.level) {
...
c.gameData.userData.isHall = !1;
c.gameData.storageData();
cc.director.loadScene(l.scene.game);
} else this.hall.showToast("The level has not been unlocked yet");
};
a([ d(cc.Node) ], e.prototype, "hall_mask", void 0);
a([ d(cc.Sprite) ], e.prototype, "img", void 0);
return a([ u ], e);
}(cc.Component);
o.default = h;
cc._RF.pop();
...
var c = t("./tool/gameData"), s = t("./tool/global"), l = t("./tool/StorageUtils"), r = t("./tool/utils"), u = cc._decorator, d = u.ccclass, h = u.property, p = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.loading_bg = null;
...
var e = l.StorageUtils.getStorageJSON(c.storage.gamedata);
e && (c.gameData.userData = e);
s.Global.setsceneNode(this.node);
if (c.gameData.userData.isClause) {
...
callback: function() {
c.gameData.userData.isClause = !0;
...
c.gameData.setVideoFailCb(function() {
...
if (c.gameData.userData.isHall) cc.director.loadScene(r.scene.hall); else {
s.Global.imgId = c.gameData.userData.level;
...
jsb.reflection.callStaticMethod("UnityMgr", "testlog", "()V");
};
a([ h(cc.Node) ], e.prototype, "loading_bg", void 0);
a([ h(cc.Sprite) ], e.prototype, "loaging_bar_yellow", void 0);
a([ h(cc.Node) ], e.prototype, "loadingBox", void 0);
a([ h(cc.Node) ], e.prototype, "gotoHallBox", void 0);
a([ h(cc.Node) ], e.prototype, "loading_play", void 0);
return a([ d ], e);
}(cc.Component);
o.default = p;
cc._RF.pop();
...
var c = cc._decorator, s = c.ccclass, l = c.property, r = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.dong1_top = null;
...
a([ l(cc.Node) ], e.prototype, "dong1_top", void 0);
a([ l(cc.Node) ], e.prototype, "dongdong1_bottom", void 0);
a([ l(cc.Node) ], e.prototype, "hand1", void 0);
a([ l(cc.Node) ], e.prototype, "dong2_top", void 0);
a([ l(cc.Node) ], e.prototype, "dongdong2_bottom", void 0);
a([ l(cc.Node) ], e.prototype, "hand2", void 0);
return a([ s ], e);
}(cc.Component);
o.default = r;
cc._RF.pop();
...
var c = cc._decorator, s = c.ccclass, l = (c.property, function(t) {
n(e, t);
function e() {
