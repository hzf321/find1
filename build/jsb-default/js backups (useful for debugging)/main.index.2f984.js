...
var i, n = t("./StorageUtils"), c = null, a = null, s = function() {
function t() {
this.levelAll = 30;
this.userData = {
isClause: !1,
...
var a = t("../tool/gameData"), s = t("../tool/global"), l = t("../tool/utils"), r = cc._decorator, u = r.ccclass, d = r.property, p = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.title = null;
...
if (5 == s.Global.imgId && !a.gameData.userData.finishLevel5) {
a.gameData.userData.finishLevel5 = !0;
...
var a, s = t("./prefeb/newhand"), l = t("./tool/gameData"), r = t("./tool/global"), u = t("./tool/utils"), d = cc._decorator, p = d.ccclass, h = d.property;
(function(t) {
t[t.find = 0] = "find";
t[t.err = 1] = "err";
t[t.finish = 2] = "finish";
...
c([ h(cc.Node) ], e.prototype, "originalImg", void 0);
c([ h(cc.Node) ], e.prototype, "finishImg", void 0);
c([ h(cc.Node) ], e.prototype, "tishi_qipao", void 0);
c([ h(cc.Prefab) ], e.prototype, "gameFindPrefab", void 0);
c([ h(cc.Prefab) ], e.prototype, "gameErrPrefab", void 0);
c([ h(cc.Prefab) ], e.prototype, "gameTishiPrefab", void 0);
c([ h(cc.Prefab) ], e.prototype, "game_tuowei", void 0);
c([ h(cc.Node) ], e.prototype, "imgSignBox", void 0);
c([ h(cc.Node) ], e.prototype, "yeziBox", void 0);
c([ h(cc.Label) ], e.prototype, "level", void 0);
c([ h(cc.Node) ], e.prototype, "timeAll", void 0);
c([ h(cc.Node) ], e.prototype, "reduceTime", void 0);
c([ h(cc.Node) ], e.prototype, "mask", void 0);
return c([ p ], e);
}(cc.Component);
o.default = g;
cc._RF.pop();
...
var a = t("./prefeb/imgItem"), s = t("./tool/global"), l = t("./tool/utils"), r = cc._decorator, u = r.ccclass, d = r.property, p = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.bg = null;
...
s.Global.audioUtils.commonBtnClick();
s.Global.assetUtils.showDialog(l.dialog.setting_dialog, {
isGame: !1
});
};
...
c([ d(cc.Node) ], e.prototype, "bg", void 0);
c([ d(cc.Prefab) ], e.prototype, "imgItem", void 0);
c([ d(cc.Node) ], e.prototype, "scroll_contect", void 0);
c([ d(cc.ScrollView) ], e.prototype, "scrollView", void 0);
c([ d(cc.Node) ], e.prototype, "toastNode", void 0);
return c([ u ], e);
}(cc.Component);
o.default = p;
cc._RF.pop();
...
var a = t("./tool/gameData"), s = t("./tool/global"), l = t("./tool/StorageUtils"), r = t("./tool/utils"), u = cc._decorator, d = u.ccclass, p = u.property, h = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.loading_bg = null;
...
c([ p(cc.Node) ], e.prototype, "loading_bg", void 0);
c([ p(cc.Sprite) ], e.prototype, "loaging_bar_yellow", void 0);
c([ p(cc.Node) ], e.prototype, "loadingBox", void 0);
c([ p(cc.Node) ], e.prototype, "gotoHallBox", void 0);
c([ p(cc.Node) ], e.prototype, "loading_play", void 0);
return c([ d ], e);
}(cc.Component);
o.default = h;
cc._RF.pop();
