...
var i, n = t("./StorageUtils"), a = function() {
function t() {
this.levelAll = 30;
this.userData = {
isClause: !1,
...
t.prototype.setVideoFailCb = function() {};
t.prototype.showVideo = function(t) {
console.log("android------------看广告");
cc.sys.isNative && cc.sys.OS_ANDROID == cc.sys.os ? jsb.reflection.callStaticMethod("org/cocos2dx/javascript/AppActivity", "showShiPing", "()V") : t();
};
...
var c = t("../tool/gameData"), s = t("../tool/global"), l = t("../tool/utils"), r = cc._decorator, u = r.ccclass, d = r.property, p = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.title = null;
...
var c, s = t("./prefeb/newhand"), l = t("./tool/gameData"), r = t("./tool/global"), u = t("./tool/utils"), d = cc._decorator, p = d.ccclass, h = d.property;
(function(t) {
t[t.find = 0] = "find";
t[t.err = 1] = "err";
t[t.finish = 2] = "finish";
...
a([ h(cc.Node) ], e.prototype, "originalImg", void 0);
a([ h(cc.Node) ], e.prototype, "finishImg", void 0);
a([ h(cc.Node) ], e.prototype, "tishi_qipao", void 0);
a([ h(cc.Prefab) ], e.prototype, "gameFindPrefab", void 0);
a([ h(cc.Prefab) ], e.prototype, "gameErrPrefab", void 0);
a([ h(cc.Prefab) ], e.prototype, "gameTishiPrefab", void 0);
a([ h(cc.Prefab) ], e.prototype, "game_tuowei", void 0);
a([ h(cc.Node) ], e.prototype, "imgSignBox", void 0);
a([ h(cc.Node) ], e.prototype, "yeziBox", void 0);
a([ h(cc.Label) ], e.prototype, "level", void 0);
a([ h(cc.Node) ], e.prototype, "timeAll", void 0);
a([ h(cc.Node) ], e.prototype, "reduceTime", void 0);
a([ h(cc.Node) ], e.prototype, "mask", void 0);
return a([ p ], e);
}(cc.Component);
o.default = g;
cc._RF.pop();
...
var c = t("./prefeb/imgItem"), s = t("./tool/gameData"), l = t("./tool/global"), r = t("./tool/utils"), u = cc._decorator, d = u.ccclass, p = u.property, h = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.bg = null;
...
a([ p(cc.Prefab) ], e.prototype, "imgItem", void 0);
a([ p(cc.Node) ], e.prototype, "scroll_contect", void 0);
a([ p(cc.ScrollView) ], e.prototype, "scrollView", void 0);
a([ p(cc.Node) ], e.prototype, "toastNode", void 0);
return a([ d ], e);
}(cc.Component);
o.default = h;
cc._RF.pop();
...
var c = t("./tool/gameData"), s = t("./tool/global"), l = t("./tool/StorageUtils"), r = t("./tool/utils"), u = cc._decorator, d = u.ccclass, p = u.property, h = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.loading_bg = null;
...
a([ p(cc.Sprite) ], e.prototype, "loaging_bar_yellow", void 0);
